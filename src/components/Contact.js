    ...
    <div>
      ...
      <div className='flex mt-[60px] mx-[110px] mb-[80px] gap-[15px]'>
        <div className='w-[44%] pr-[35px]'>
          ...
          <p className='text-left text-[20px]'>At NextSolutions.in, we are dedicated to providing our clients with the best IT services available. Contact us today to 
          learn more about how we can help your business thrive.</p>
          <div className='mt-[50px] pl-[10px]'>
            <div className='flex gap-[15px]'>
              ...
              <div className='text-left'>
                <p className='font-semibold text-[24px]'>Address</p>
                <p className='text-[#7A7A7A] font-normal '>Faridabad, Haryana</p>
              </div>
            </div>
            <div className='flex gap-[15px] mt-[20px]'>
              ...
              <div className='text-left'>
                ...
                <p className='text-[#7A7A7A] font-normal '>info@nextsolutions.com</p>
              </div>
            </div>
          </div>
        </div>
        <div className='pt-[20px] pb-[40px] bg-[#F8F8F8] px-[40px] text-left'>
          ...
          <form>
            ...
            <button type='reset' className='px-[40px] mt-[10px] py-[13px] bg-[#D9157F] font-medium text-[#fff] text-[16px] tracking-wide rounded-[5px]'>Send Message</button>
          </form>
