    ...
    <div className='spacesek'>
      ...
      <div className='min-[767px]:flex mt-[60px] min-[767px]:mx-[110px] mb-[80px] gap-[15px]'>
        <div className='min-[767px]:w-[44%] min-[767px]:pr-[35px] max-[767px]:pr-[15px] max-[767px]:pl-[10px]'>
          ...
          <div className='mt-[50px] min-[767px]:pl-[10px]'>
            <div className='flex gap-[15px] max-[767px]:flex-col max-[767px]:items-center'>
              ...
              <div className='min-[767px]:text-left'>
                <p className='font-semibold text-[24px] max-[767px]:text-[20px]'>Address</p>
                <p className='text-[#7A7A7A] font-normal dmsans max-[767px]:text-[16px]'>Faridabad, Haryana</p>
              </div>
            </div>
            <div className='flex gap-[15px] mt-[20px] max-[767px]:flex-col max-[767px]:items-center'>
              ...
              <div className='min-[767px]:text-left max-[767px]:mt-[5px] max-[767px]:mb-[15px]'>
                <p className='font-semibold text-[24px] max-[767px]:text-[20px]'>Email</p>
                <p className='text-[#7A7A7A] font-normal dmsans max-[767px]:text-[16px]'>info@nextsolutions.com</p>
              </div>
            </div>
          </div>
        </div>
        <div className='pt-[20px] pb-[40px] bg-[#F8F8F8] px-[40px] text-left max-[767px]:mr-[50px]'>
          ...
          <form target='_blank' rel='nofollow' action="mailto: japurv27@gmail.com">
            <div className='min-[767px]:flex w-[100%] justify-between gap-[10px]'>
              <div className='min-[767px]:w-[50%]'>
                <input type="text" placeholder='Your Name' className='rounded-[5px] p-[15px] w-[100%]'></input>
              </div>
              <div className='min-[767px]:w-[50%] max-[767px]:mt-[10px]'>
